EZO_GROUP_FRAMES_STRINGS_ES = {
    ...
    EZO_GF_OPTION_HIDE_NATIVE = "Ocultar frames nativos mientras este activo",
    EZO_GF_OPTION_HIDE_NATIVE_TOOLTIP = "Oculta el contenedor nativo de frames de grupo de ESO solo mientras EZOGroupFrames muestra sus propios frames.",
